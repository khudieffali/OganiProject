...
{
    internal class BlogDeleteHandlerRequest(IBlogRepository blogRepository, IFileService fileService, IBlogCategoryRepository blogCategoryRepository) : IRequestHandler<BlogDeleteRequest, IEnumerable<BlogGetAllDto>>
    {
